...
function currentWeather(wttr) {
    ...
    var now = messages.subheading(wttr.name);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    spinner = spin();
                    if (!yargs_1.argv.key) return [3 /*break*/, 2];
                    return [4 /*yield*/, api.storeApiKey(yargs_1.argv.key)["catch"](function (err) {
                            spinner.stop();
                            handleError(err);
                        })];
                case 1:
                ...
                case 2:
                    ...
                    _b = (_a = api).getWeather;
                    return [4 /*yield*/, api.getLatLong()];
